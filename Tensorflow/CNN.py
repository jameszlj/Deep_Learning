...
def conv2d(x, W):
    """tensorflow 2d conv function"""
    return tf.nn.conv2d(x, W, strides=[1, 1, 1, 1], padding="SAME")


def max_pool_2x2(x):
    """pooling sparse param"""
...
# x_s ===>[-1, 28, 28, 1]
x_image = tf.reshape(x_s, [-1, 28, 28, 1])
# print(x_image.shape)  # [?, 28, 28, 1]
...
# *****func1 layer *****
W_fc1 = weight_variable([7*7*64, 1024])  # expand output size 1024(hight)
